...
Windows XP 及以下版本的配置方式可以参看上海大学 NTP 网站上提供的[教程](http://cms.shu.edu.cn/Default.aspx?alias=cms.shu.edu.cn/ntp)。Windows Vista/7 及以上的配置方式暂缺，请参考[博客链接](https://clamis.net/how-to-change-windows-10-ntp-2.html)，也可参考[issue说明](https://github.com/tuna/tuna.moe/issues/17)。
